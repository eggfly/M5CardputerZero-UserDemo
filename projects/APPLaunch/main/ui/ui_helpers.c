...
void _ui_anim_callback_free_user_data_and_ready_cb(lv_anim_t * a)
{
    ui_anim_user_data_t *anim_data = (ui_anim_user_data_t *)a->user_data;
    if(anim_data->ready_cb) 
        anim_data->ready_cb(a);
